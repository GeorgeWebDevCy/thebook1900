...
// PHP 8+ compatibility: parameters with defaults must not be declared before required parameters.
// $width and $height are logically required, but we provide defaults and validate them.
function rt_vt_resize( $attach_id = null, $img_url = null, $width = null, $height = null, $crop = false, $v_crop = false ) {

	// Fail fast if width/height weren't provided (keeps legacy behavior predictable).
